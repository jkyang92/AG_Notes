...
\input{sections/sections-7-8-9.tex}
...
\end{equation}
where $D^{\on{sing}}(E)$ denotes the singularity category of $E$, and $\Perf(E)$ is the category of perfect complexes in $E$. This is a ``geometric" version of the BGG correspondence, though an unsatisfying one. All of the geometry on the exterior algebra side is hidden in the localization 
