...
There is a classical method for explicating the morphisms in a derived category, namely replacing it with an appropriate homotopy category. For instance, $D^b(E)$ is equivalent to the homotopy category $K^-(E)$ of complexes of finitely generated free $E$-modules whose terms vanish in large homological degrees. 
