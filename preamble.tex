...
\newcommand{\lauren}[1]{{\color{orange} \sf $\clubsuit$ Lauren: [#1]}}
\newcommand{\jay}[1]{{\color{Magenta} \sf $\spadesuit\spadesuit\spadesuit$ Jay: [#1]}}
...
% preserve the dotless-i used by bibtex entries, e.g. \u{\i} in Eloísa
\let\dotlessi\i
\def\i{\ifmmode\iota\else\dotlessi\fi}
