...
\begin{thm}
    The following conditions on an element $d\in \Cl(X)\otimes \QQ$ are equivalent:.
    \begin{enumerate}
        ...
        $F_{\ell,*}\cO_X$ for some $\ell$, or, equivalently, for every sufficiently large $\ell$ \footnote{This can be done in the simplicial case as
        well by using the toric stack; see \cite[Remark 5.4]{HHL}.}.
     \end{enumerate}
\end{thm}
\begin{proof}
(1) $\equiv$ (2):
...
%(2) $\Rightarrow$ (1): Suppose $d\in\Cl(X)$ is such that there exist
...
(2) $\equiv$ (4) We follow the proof given in \cite[Theorem 1.1]{achinger}:
