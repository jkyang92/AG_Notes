...
\begin{proof}
    ...
    For (3) implies (1):  Define the positive grading $\phi$ by choosing a projection of vector spaces \lauren{is this what you meant?} $\Cl(S)\otimes \QQ\to \QQ$ that sends the pointed cone $\Eff(S)_{\QQ}$ into $\QQ_{>0}$ and then clearing denominators as needed so that the image of $\Eff(S)$ lies in $\ZZ$.
  \end{proof}
