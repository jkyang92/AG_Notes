...
\begin{remark}
\label{rem:pullpush}
It is an easy consequence of the projection formula that $\Phi_{i, j} = Rq_* \circ p^*$. To see this, let $f \co X \to X \times Y$ denote the inclusion of $\Gamma_{ij}$ in $X \times Y$. We have:
$$
